...
const Navbar = () => {
    ...
    return (
        <nav className="h-[10vh] xl:bg-black mt-4 text-white relative z-50">
            <div className="max-w-7xl font-manrope mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center w-[80%] justify-between">
                        ...
                        <div className='w-[30%]'>
                            <button onClick={(e) => Router.push("https://forms.gle/8uXKTbTn16oe9ftK6")} className="bg-white text-black flex items-center justify-center  font-bold ml-[5rem]  text-[1.3rem] px-14 py-2 rounded-md hover:bg-gray-500 transition-colors duration-200">
                                Register
                            </button>
                        </div>
                    </div>
